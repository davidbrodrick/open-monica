...
/**
 * Merge two 16 bit integers to reassemble a 32 bit double integer.
 *
 * <p>
 * First field is Most Significant 16 bits, Second field is Least Significant 16 bits of 32 bit double.
 *
...
public class TranslationShorts2Double extends Translation {  
	...
	protected static String[] itsArgs = new String[]{"Translation Shorts2Double", "Shorts2Double", "Array index of most significant", "Array index of least significant", "java.lang.Integer"};
	...
	public PointData translate(PointData data) {
		...
		res.setData((itsHigh*65536)  + itsLow);
