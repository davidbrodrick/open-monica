 ...
 * <P>A monitor point that uses this translation would normally have a
 * <i>Listen</i> transaction that listens to a monitor point whose data
 * is an array. This translation would then extract a single entry from the
 * array and output just that entry.
 *
...
extends Translation
{
  ...
  protected static String[] itsArgs = new String[]{"Translation Array",
  ...
  TranslationArray(PointMonitor parent, String[] init)
  {
    super(parent, init);
    if (init.length!=1) {
      System.err.println("ERROR: TranslationArray (for " + itsParent.getName()
