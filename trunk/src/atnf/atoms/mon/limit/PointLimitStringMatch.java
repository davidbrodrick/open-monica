...
/**
 * <i>PointLimit</i> sub-class which checks if a String data-value matches a predefined
 ...
 */
class PointLimitStringMatch extends PointLimit {
  ...
  public PointLimitStringMatch(String[] args) {
    if (args.length < 2) {
      // This is a problem
      System.err.println("PointLimitStringMatch: " + "Need at least two arguments!!!");
    } else {
