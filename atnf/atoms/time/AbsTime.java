 ...
 *
 * <p>
 * An absolute time represents an epoch
 * and cannot be negative.
 * Adding two <code>AbsTime</code> values makes no sense,
 * but it is possible to add a <code>RelTime</code> value to a
 * <code>AbsTime</code>.
 * It is also possible to find
 * the difference between two <code>AbsTime</code> values,
 * with the result being a <code>RelTime</code> value.
 *
 * <p>
 * There are two "special" times,
 * which are represented by their own objects
 * they are:
 * <ul>
 *  <li><code>NEVER</code>:
 *    The time will never come.
 *    All times are "before" <code>NEVER</code>
 *    except <code>NEVER</code> itself.
 *    Adding any relative time to <code>NEVER</code>
 *    yields <code>NEVER</code>.</li>
 *  <li><code>ASAP</code>:
 *    The required time is as soon as reasonably possible.
 *    <code>ASAP</code> is "before" any other times
 *    except <code>ASAP</code> itself.</li>
 * </ul>
 *
 * <p>
 * The string representation of a <code>AbsTime</code> is specified
 * by any object of type <code>AbsTime.Format</code>.
 * Each of these formats is augmenged by the following literals:
 * <ul>
  ...
  Comparable
{
   ...
   */
  final public static
  String RCSID = "$Id: AbsTime.java,v 1.46 2006/09/13 04:09:02 bro764 Exp $";

  /**
   * String formats for absolute times.
   *
   * Objects of this class represent the different string formats
   * that an <code>AbsTime</code> value can take.
   */
  final public static
  class Format
  extends Enum
  {
     ...
     * This format is equivalent to an unsigned decimal integer.
     */
    final public static
     ...
     */
    final public static
    int FORMATTED_BAT_ORD = 2;

    /**
     * Indicates a string formatted as formatted BAT.
     * The string consists of the time represented in hexadecimal
     * with a space every four digits.
     * The format looks something like
     * "<samp>XXXX&nbsp;XXXX&nbsp;XXXX&nbsp;XXXX</samp>".
     * There is always 16 hexadecimal digits
     * (filled with leading zeros if necessary).
     * The total length of the string is always 19 digits.
     */
    final public static
    Format FORMATTED_BAT = new Format(FORMATTED_BAT_ORD,"FORMATTED_BAT");
    ...
    /**
     * Indicates a string formatted as simple BAT.
     * The string consists of the time represented as a
     * hexadecimal number.
     * The first string is prefixed by "<samp>0x</samp>",
     * then between 1 and 16 hexadecimal digits.
     */
    final public static
    Format HEX_BAT = new Format(HEX_BAT_ORD,"HEX_BAT");
    ...
    /**
     * Indicates a string formatted as decimal seconds.
     * The string looks like a floating number which is the seconds
     * equivalent of the numerical BAT.
     */
    final public static
     ...
     */
    final public static
    int UTC_STRING_ORD = 5;

    /**
     * Indicates a string formatted as a UTC date/time string
     * in the format YYYY-MM-DD HH:MM:SS.sss
     */
    final public static
    Format UTC_STRING = new Format(UTC_STRING_ORD,"UTC_STRING");
   ...
   */
  final public static
  AbsTime ASAP = new AbsTime(false);
   ...
   */
  final static
  long NEVER_CODE = 0xFFFFFFFFFFFFFFFFL;

  /**
   * The current default output format.
   */
  private static
  Format theirDefaultFormat = Format.HEX_BAT;

  /**
   * Time is stored as a <code>long</code> and converted to whatever
   * else is requred. The <code>long</code> data type provides us
   * with the 64-bit number required to store a BAT.
   *
   * <p>
  ...
  /**
   * Makes a time that is equivalent to NOW to the best ability
   * of the host.
   * Note that the quality of
   * this time may vary wildly between hosts and implementations.
   *
   * @return
   *  The new object.
   *
   * @exception Time.Ex_TimeNotAvailable
   *  Thrown when absolute time is not available on the host.
   */
  public static
  AbsTime
  factory()
  throws
    Time.Ex_TimeNotAvailable
  {
    return new AbsTime();
  }
   ...
   * This constructor remains intact only in order to support
   * serialization.</p>
   *
   * @exception Time.Ex_TimeNotAvailable
   *  Thrown when absolute time is not available on the host.
  ...
  /**
   * Construct an object representing a specific time given by a
   * <code>long</code>.
   *
   * @param t
   *  A number that is the required BAT.
   *
   * @return
   *  The new object.
   */
   ...
   * @param t
   *  A number that is the required BAT.
   *  Must not be one of the special codes.
   */
  private
  AbsTime(
    long t
   ...
   *
   * @param t
   *  The existing <code>AbsTime</code> object.
  ...
  /**
   * Construct an object representing a specific time.
   * The time represented by the object will be now,
   * plus a specified relative time.
   *
   * @param dt
   *  The time offset for the new absolute time.
   *  A positive value will make a time in the future.
   ...
   *  Thrown if <code>dt</code> is <code>null</code>.
   */
  public static
  AbsTime
  factory(
    ...
    IllegalArgumentException
  {
    ...
    itsValue = (System.currentTimeMillis() * 1000L) +
        DUTC.get() * 1000000L + 3506716800000000L;
  ...
  /**
   * Construct an object representing a specific time specified by
   * a string.
   *
   ...
   *
   * @param t
   *  A string representation of an absolute time in any of the
   ...
   *  Thrown when <code>t</code> is not a valid string
   *  representation of an <code>AbsTime</code> object.
   *
   * @exception Time.Ex_TimeNotAvailable
   *  Thrown when a time of <code>NOW</code> is requested,
   *  but real time is not available on this host.
   */
  public static
  AbsTime
  factory(
   ...
   * @param date
   *   The date to convert. Really shouldn't be null
   * @return
   *   The AbsTime object created
   **/
  ...
  /**
   * Construct an object representing either <code>ASAP</code>
   * or <code>NEVER</code>.
   *
   * @param t
   *  A value of <code>false</code> makes <code>ASAP</code>.
   *  A value of <code>true</code> makes <code>NEVER</code>.
   *
   * @deprecated
   *  Use the corresponding factory method instead.
   */
  private
  AbsTime(
    boolean t
   ...
   *
   * @return
   *  The value of the time as seconds since the zero epoch.
   */
  public
  double
  getAsSeconds()
   ...
   *
   * @return
   *  A string containing the representation of the object in
   *  the "default" format.
   */
  public
  String
   ...
   *
   * @param format
   *  Any object of type <code>Format</code>.
   *  A value of <code>null</code> indicates to use the current
   *  default format for the class.
   *
   * @return
   *  A string containing the representation of the number according
   *  to the format defined by <code>format</code>.
   */
  public
  String
  toString(
    ...
    // Check format against each available format.
      switch(format.ord()) {
        ...
        case Format.FORMATTED_BAT_ORD: {
          ...
          // string.
          res = fBAT.substring(0,4) + " " + fBAT.substring(4,8) + " " +
              fBAT.substring(8,12) + " " + fBAT.substring(12,16);
          break;
        }
  ...
  /**
   * Add a period to this object and return it as a new object.
   * This method just instanciates a RelTime object and calls the
   * other add method. It is provided for convenience only.
   * <P>
   * Adding to <code>ASAP</code> is not defined and
   * throws an exception.
   * Adding to <code>NEVER</code> always yields <code>NEVER</code>.
   *
   * @param t2
   *  The amount of time to add to this object.
   *
   * @return
   ...
   *  Thrown if
   *    <ul>
   *      <li>the resulting time would be out of the range of an
   *        <code>AbsTime</code>.</li>
  ...
  /**
   * Add a relative time to this object and return it as a new object.
   * Adding to <code>ASAP</code> is not defined and
   * throws an exception.
   * Adding to <code>NEVER</code> always yields <code>NEVER</code>.
   *
   ...
   *
   * @return
   *  The value <code>true</code> if this object is equal to the
   *  special time <code>ASAP</code>.
   */
  public
  boolean
  isASAP()
   ...
   *
   * @param refEpoch
   *  The reference epoch to test against.
   *  Must not be equal to <code>null</code>.
   *
   * @return
   *  The value -1 if this time is before the
   *  <code>refEpoch</code>, 0 if times are equal,
   *  +1 otherwise.
   */
  public
  int
   ...
   *
   * @return
   *  The value <code>true</code> this time is before the
   *  <code>refEpoch</code>,
   *  <code>false</code> otherwise.
   */
  public
   ...
   *
   * @return
   *  The value <code>true</code> this time is before or equal
   *  to <code>refEpoch</code>,
   *  <code>false</code> otherwise.
   */
  public
  boolean
   ...
   *
   * @return
   *  The value <code>true</code> this time is after
   *  <code>refEpoch</code>,
   *  <code>false</code> otherwise.
   */
  public
   ...
   *
   * @return
   *  The value <code>true</code> this time is after or
   *  equal to <code>refEpoch</code>,
   *  <code>false</code> otherwise.
   */
  public
  boolean
  ...
  /**
   * Make the calling thread wait until the time represented by
   * this object.
   * Speeping until <code>ASAP</code> is defined
   * as doing nothing.
   * Sleeping until <code>NEVER</code> is not defined
   ...
   *  The thread was awoken during its sleep.
   *
   * @exception IllegalArgumentException
   *  Thrown when the object represents <code>NEVER</code>.
   *
   * @exception Ex_TimeNotAvailable
   *  Time is not available on this host.
   *
   * @exception Ex_TooLate
   *  The time represented by the object is in the past.
   */
  public
  void
  sleep()
   ...
   *
   * @return
   *  The current BAT (from the system clock).
   */
  private
  long
  timeNow()
    ...
    Time.Ex_TimeNotAvailable
  {
    ...
    if((str.length() >= 3) && (str.substring(0,2).equals("0x"))) {
      ...
      // Fifth character is a space, therefore should be in
      // FORMATTED_BAT format.
      parseFormattedBAT(str);
    }
    else if(str.indexOf('.') != -1) {
      // The string contains a "." charcater. Try to parse it as
      // SECS_BAT.
      parseSecsBAT(str);
    }
    else {
    ...
    if(isASAP() || isNEVER()) {
      throw new NumberFormatException(
          "absolute time reserved value: \"" + str + "\"");
    }
  }

  /**
   * Attempt to parse a string as <code>HEX_BAT</code>.
   * Set the value of this object to the result.
   *
   * <p>
   * Note: broken for times greater than 0x0FFFFFFFFFFFFFFF.
   * This is left because these times are not physically relevent.
   *
   * @param str
   *  The string formatted as <code>HEX_BAT</code>.
   *
   * @exception NumberFormatException
   *  Thrown when <code>str</code> is not a valid <code>HEX_BAT</code>
   *  string.
   *  The value of the object is left unchanged.
   */
  private
  void
  parseHexBAT(
  ...
  /**
   * Attempt to parse a string as <code>FORMATTED_BAT</code>.
   * Set the value of this object to the result.
   *
   * <p>
   * Note: broken for times greater than 0x0FFFFFFFFFFFFFFF.
   ...
   *
   * @param str
   *  The string formatted as <code>FORMATTED_BAT</code>.
   *
   * @exception NumberFormatException
   *  Thrown when <code>str</code> is not a valid
   *  <code>FORMATTED_BAT</code> string.
   *  The value of the object is left unchanged.
   */
  private
  void
  ...
  /**
   * Attempt to parse a string as <code>DECIMAL_BAT</code>.
   * Set the value of this object to the result.
   *
   * <p>
   * Note: broken for times greater than 0x7FFFFFFFFFFFFFFF.
   * This is left because these times are not physically relevent.
   *
   * @param str
  ...
  /**
   * Attempt to parse a string as <code>SECS_BAT</code>.
   * Set the value of the object to the result.
   *
   * param str
...
//      theValue = (long)(Double.parseDouble(str) * 1000000.0);
  ...
  /**
   * Fill a string representation of a number with leading zeros to
   * the indicated string length.
   *
   * @param str
   *  The input string.
   *
   ...
   *
   * @return
   *  A string equivalent to <code>str</code>,
   *  but filled with leading zeros and the length given by
   *  <code>len</code>.
   *
   * @exception IllegalArgumentException
   *  Thrown when the requested string length,
   *  <code>len</code>,
   *  is not greater than the existing
   *  string length,
  ...
  /**
   * Trim all white space from a string (leading, trailing and
   * included).
   *
   * @param str
   ...
   *
   * @return
   *  A string that is <code>str</code> with all the white space
   *  removed.
   */
  private static
  String
   ...
   * subsequent options and arguments are command specific.
   * Valid commands are
   * (along with subsequent options and arguments):
   * <ul>
   *  <li><code><b>clock</b></code><br>
   *    Make a GUI BAT clock.
   *    Options are:
   *    <ul>
   ...
   *        Specifies the initial foreground color.</li></ul>
   *  <li><code><b>formats</b></code><br>
   *    Print a list of the valid formats.</li>
   *  <li><code><b>print [-f <i>fmt</i>] <i>time</i></b></code><br>
   *    Print the value of <code><i>time</i></code>.
   *    Options are:
   *    <ul>
   *      <li><code>-f <i>fmt</i></code><br>
   *        Specifies the format to print the time in.
   *        The <i>fmt</i> is one of the valid format specifiers.
   *        If this option is not specified,
   *        the default format is used.</li>
   *    </ul>
   *    The string <code><i>time</i></code> can be in any
   *    of the valid string formats for an absolute time.</li>
   ...
   *        the default format is used.</li>
   *      <li><code>-r</code><br>
   *        Specifies that the time is automatically updated
   *        every second.</li>
   *    </ul></li>
   * </ul>
   */
...
/// testing    
    ...
    if(args[0].equals("test")) {
      ...
      for (int i=0; i<100000; i++) {
        now.compare(later); now.compare(NEVER);
      }
      System.out.println(new AbsTime()+" doing 200000 isBefore()s");
      for (int i=0; i<100000; i++) {
        now.isBefore(later); now.isBefore(NEVER);
      }
      System.out.println(new AbsTime()+" doing 200000 isAfter()s");
      for (int i=0; i<100000; i++) {
        now.isAfter(later); now.isAfter(NEVER);
      }
