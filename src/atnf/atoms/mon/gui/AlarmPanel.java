...
/**
 * AlarmPanel class for use by the AlarmManagerPanel class and the automated AlarmPopupFrame class. Basic JPanel extension that
 * displays some basic information about an alarm in a user-friendly manner so they can quickly and easily assess the alarm and make
...
public class AlarmPanel extends JPanel {
	private static HashMap<Integer, String> rankLookup = new HashMap<Integer, String>(5);
	static {
	 ...
	 * 
	 * @param name
	 *          The name of the point in dotted-delimiter format
	 */
	 ...
	 * 
	 * @param c
	 *          The colour to highlight the alarm in
	 */
