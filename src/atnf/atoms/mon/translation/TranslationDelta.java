...
/**
 * Calculate the difference between successive monitor point values, calculated as
 * <tt>prev_val - new_val</tt>. This class can handle <i>Number</i> or <i>Angle</i>
 * data types. Angles are treated specially in that we try to handle phase wraps
