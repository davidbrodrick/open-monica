 ...
 * @version $Id: TranslationEnumMap.java,v 1.3 2004/10/28 23:44:58 bro764 Exp bro764 $
 */
public class
TranslationEnumMap
extends Translation
{
  ...
  translate(PointData data)
  {
    ...
    if (!(val instanceof Number)) {
      ...
      System.err.println("TranslationEnumMap for " + itsParent.getSource()
			 + "." + itsParent.getName() + ": Got NON-NUMERIC"
			 + " data..");
      return null;
    }
