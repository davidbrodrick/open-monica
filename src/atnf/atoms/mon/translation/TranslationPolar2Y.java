 ...
 * and return the Y cartesian component of the vector.
 * 
 ...
 */
public class TranslationPolar2Y extends TranslationDualListen
{
    /** Set to true if the angle represents degrees. */
    private boolean itsDegrees = false;

    public TranslationPolar2Y(PointDescription parent, String[] init)
    {
        super(parent, init);
    ...
    protected Object doCalculations(Object val1, Object val2)
    {
        if (!(val1 instanceof Number) || !((val2 instanceof Number) || (val2 instanceof Angle))) {
            System.err.println("TranslationPolar2Y: " + itsParent.getFullName() + ": ERROR got invalid data!");
            return null;
        }
