...
public class MonClientUtil {
	 ...
	 * @param panel The JPanel this is being shown over
	 * @param uname The existing username reference
	 * @param pwd The existing password reference
	 * @return A String[2] with the username at String[0] and the password at String[1]
	 */
	public static String[] showLogin(Component panel, String uname,
			String pwd) {
