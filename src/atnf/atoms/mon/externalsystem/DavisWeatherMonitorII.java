 ...
 * weather.Pressure            "Atmospheric Pressure"        "Pressure"    "hPa"  site T Listen-"$1.hidden.davis.data"     -  {NV-"PRES", Mean-"60", NumDecimals-"2"}     -             {TIMER-180}          1500000  -
 ...
 * weather.PressureMSL         "Mean Sea Level Pressure"     "Pressure"    "hPa"  site T Listen-"$1.weather.Pressure"      -  {EQ-"x+0"}                                  -             {TIMER-180}          1500000  -
