 ...
 * 
 * <P>
 * The corresponding monitor-points.txt entries should be something like this:
 * <tt>
...
class ThyconUPS extends ASCIISocket {
  ...
  /**
   * Send a request packet using the given request code. If a valid response is
  ...
  private void parseResponse(String resp, HashMap<String, Object> map) {
    ...
    if (bytes[3] == '8' && bytes[4] == '0') {
      ...
      // EE == Hex string representation of decimal alarm code. eg "48" == 72 ==
      // "DC
      // AT
      // FLOAT"
  ...
  private HashMap<String, Object> getNewData() throws Exception {
    ...
    try {
      ...
      logger.error("In getNewData method:" + e);
      e.printStackTrace();
    }
    return res;
  }
