...
public class AlarmCheckBoolean extends AlarmCheck {
	...
	public AlarmCheckBoolean(PointDescription parent, String[] args)
	...
	/**
	 * Checks if the value will raise an alarm with respect to the determined
	 * Boolean alarm value.
	 * 
	 * @param data
	...
	public void checkAlarm(PointData data) {
		...
		if (myData instanceof Boolean) {
			...
			Logger logger = Logger.getLogger(Factory.class.getName());
			logger.error("AlarmCheckBoolean: ERROR: " + data.getName()
					+ " has NON-BOOLEAN data!");
			return;
		}
