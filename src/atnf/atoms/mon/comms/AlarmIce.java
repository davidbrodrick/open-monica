...
public class AlarmIce implements java.lang.Cloneable, java.io.Serializable
{
    ...
    {
        int __h = 5381;
        __h = IceInternal.HashUtil.hashAdd(__h, "::atnf::atoms::mon::comms::AlarmIce");
        __h = IceInternal.HashUtil.hashAdd(__h, pointname);
        __h = IceInternal.HashUtil.hashAdd(__h, data);
        __h = IceInternal.HashUtil.hashAdd(__h, alarm);
        __h = IceInternal.HashUtil.hashAdd(__h, shelved);
        __h = IceInternal.HashUtil.hashAdd(__h, shelvedBy);
        __h = IceInternal.HashUtil.hashAdd(__h, shelvedAt);
        __h = IceInternal.HashUtil.hashAdd(__h, acknowledged);
        __h = IceInternal.HashUtil.hashAdd(__h, acknowledgedBy);
        __h = IceInternal.HashUtil.hashAdd(__h, acknowledgedAt);
        __h = IceInternal.HashUtil.hashAdd(__h, priority);
        __h = IceInternal.HashUtil.hashAdd(__h, guidance);
        return __h;
    }
    ...
    public static final long serialVersionUID = -3585015251021886585L;
}
