...
implements ActionListener, NamedObject, Comparable
{
  ...
  /**
   * The "units" of the monitor point value. For instance this might be "Volts"
   * or "Amps" or "dBm". Leave as null if units are not appropriate for a given
   * point.
   */
...
//     }
      ...
      String pointUnits = toks[2];
      String[] pointSourceArray = getTokens(toks[3]);
      String pointEnabled = toks[4];
      String[] pointInputArray = getTokens(toks[5]);
      String[] pointOutputArray = getTokens(toks[6]);
      String[] pointTranslateArray = getTokens(toks[7]);
      String[] pointLimitsArray = getTokens(toks[8]);
      String[] pointArchiveArray = getTokens(toks[9]);
      String pointPeriod = toks[10];
  ...
  FakeMonitor.Fakefactory(pointNameArray, pointLongDesc, pointUnits,
              pointSourceArray[i], pointInputArray, pointOutputArray,
              pointTranslateArray, pointLimitsArray,
              pointArchiveArray, pointPeriod, pointEnabledArray[i]
  )
